          ...
          <md-step md-label="Customer" :md-continue="stepOneContinue">
            ...
            <div class="row" style="font-size:15px">
              <div class="col-md-4 botmargin">
                <md-input-container>
                  <label>Name</label>
                  <md-input v-model="customerData.name" readonly disabled></md-input>
                </md-input-container>
              </div>
              <div class="col-md-4 botmargin">
                <md-input-container>
                  <label>Occupation</label>
                  <md-input v-model="customerData.occupation" readonly disabled></md-input>
                </md-input-container>
              </div>
              <div class="col-md-4 botmargin">
                <md-input-container>
                  <label>Office Address</label>
                  <md-input v-model="customerData.officeAddress" readonly disabled></md-input>
                </md-input-container>
              </div>
              <div class="col-md-4 botmargin">
                <md-input-container>
              ...
              <div class="col-md-4 botmargin">
                <md-input-container>
                  ...
                  <md-input v-model="customerData.dob" type="date" readonly disabled></md-input>
                </md-input-container>
              </div>
              <div class="col-md-4 botmargin">
                <md-input-container>
                  <label>Delivery Address</label>
                  <md-input v-model="customerData.deliveryOffice" readonly disabled></md-input>
                </md-input-container>
              </div>
              <div class="col-md-4 botmargin">
                <md-input-container>
                  <label>E-mail</label>
                  <md-input v-model="customerData.email" readonly disabled></md-input>
                </md-input-container>
              </div>
              <div class="col-md-4 botmargin">
                <md-input-container>
                  <label>Refer By</label>
                  <md-input v-model="customerData.referby" readonly disabled></md-input>
                </md-input-container>
              </div>
            </div>
            <hr>
          ...
          <md-step md-label="Create Order" :md-disabled="!stepOneContinue" :md-continue="stepTwoContinue" md-button-continue="PAY NOW">
              ...
              <md-card-content>
                <div class="row">
                    <div class="col-md-3">
                      ...
                      <p class="text-danger">*Enter valid department</p>
                    </div>
                </div>
            ...
            <md-card>
              ...
              <md-card-content>
                ...
                <br>
                <button class="btn btn-info" @click="addRow">Add Fabric</button>
            ...
            <md-card>
              <md-card-content>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr v-for="details in detailsTable">
                      <td>Remove</td>
                ...
                <button type="button" name="button" class="btn btn-info text-center" v-on:click="saveSalesOrder">Save Order</button>
              </md-card-content>
            </md-card>
            <br>
          </md-step>

          <md-step md-label="Payment" :md-disabled="!stepTwoContinue">
            <div class="text-center">
...
export default {
  ...
  methods: {
    ...
    saveSalesOrder: function (step) {
          console.log("coming in th is api");
      ...
      if (step == 2) {
        ...
        this.$http.post(saveSalesURL, data).then(response => {
          //console.log("Sales Order save response");
          //console.log(response);
