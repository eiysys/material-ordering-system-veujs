                  ...
                  <div class="row">
                    <div class="row">
                      <div class="col-md-4">
                        <md-input-container>
                          <label>Name</label>
                          <md-textarea v-model="customerData.name" required></md-textarea>
                        </md-input-container>
                    ...
                    <div class="row">
                      ...
                      <!-- <div class="col-md-4">
                        <md-input-container>
                          ...
                          <md-textarea type="date" v-model="customerData.dob"></md-textarea>
                        </md-input-container>
                      </div> -->
                      <div class="col-md-4">
                        <md-input-container>
                ...
                <div class="col-md-6 padclasscustomer">
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-9">
                        <div class="col-md-6">
                            <input id="jacketFrontLength" class="text-center " type="text" style="padding:0; width:100%" v-model="customerData.measurements.jacketFrontLength" min="0">
                        </div>
  ...
  methods: {
    ...
    saveCustomer: function () {
      ...
      if (this.customerData.phone.trim() == '') {
          ...
          if (!/^\d+$/.test(this.customerData.phone.trim())) {
      ...
      if (this.date.day.trim() == '' && this.date.month.trim() == '' && this.date.year.trim() == '') {
        ...
        if (!/^\d+$/.test(this.date.year.trim())) {
            ...
            this.dobValidation = true
            this.date = {day:'', month: '', year: ''}
          } else if (this.date.year.trim() <= 2018) {
            yearValidated = true
          } else {
            this.dobValidation = true
            this.date = {day:'', month: '', year: ''}
      ...
      if (nameValidated == true && phoneValidated == true && emailValidated == true && dobValidated == true) {
        ...
        this.$http.post(customerURL, data).then(response => {
